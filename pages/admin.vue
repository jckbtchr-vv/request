...
const ADMIN_PASSWORD = 'VVFOREVER'
...
onMounted(() => {
  authenticated.value = localStorage.getItem('admin_auth') === ADMIN_PASSWORD
})
...
<template>
  <div style="padding: 2rem; max-width: 800px; margin: 0 auto;">
    <!-- Login gate -->
    <div v-if="!authenticated" style="max-width: 300px; margin: 4rem auto;">
      <h2 style="border: none; padding: 0; margin: 0 0 2rem 0;">Admin</h2>
      <form @submit.prevent="login">
        <div class="form-group">
          <label>Password</label>
          <input v-model="passwordInput" type="password" placeholder="Enter password" />
        </div>
        <div v-if="error" style="color: #dc3545; margin-bottom: 1rem;">Invalid password</div>
